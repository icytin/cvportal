...
<template:layout>
	...
	<div ng-app="app" ng-controller="CreateNgController">
		...
		<div class="form-group">
	  	...
	  	<div class="row">
	   		<div class="col-lg-offset-10 col-lg-2 col-md-offset-8 col-md-4 col-xs-offset-6 col-xs-6">
	   			<button ng-click="create()" class="btn btn-primary pull-right" >Skapa</button><button onclick="location= '/cvportal';" class="btn btn-default pull-right btn-margin-right">Avbryt</button>
	   		</div>
	   	</div>
	...
	<!-- Scripts section  -->
	<script src="${pageContext.request.contextPath}/resources/js/cv/createNgController.js"></script>
